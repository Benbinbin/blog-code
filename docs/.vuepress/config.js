...
module.exports = {
  ...
  plugins: [
    ...
    {
      postClassifications: ['git', 'github']
    }],
    [require('./plugins/generateFolderPages.js'),
    {
      postFolders: ['git', 'github']
    }],
  ],
  ...
  define: {
    ...
    __HOME_DESCRIPTION__: "这是我的<a href='https://benbinbin.github.io/tech-blog/' target='_blank' class='hover:text-blue-600 underline font-bold transition-colors'>技术部落格</a>之一，主要内容是我在学习编程过程中做的笔记。",
    __HOME_PAGE_COLOR__: '#9CA3AF',
    __AVATAR__: 'avatar.png',
    __CLASSIFICATIONS__: ['All', 'Git', 'Github'],
    __FOLDERS__: ['Git', 'Github'],
